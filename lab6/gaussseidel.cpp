...
GaussSeidel<T>::GaussSeidel(const AGHMatrix<T>& A_mat, const AGHMatrix<T>& b_mat, const unsigned& iterations, const double& eps) : A_mat{A_mat}, b_mat{b_mat}, x_mat{b_mat} {
