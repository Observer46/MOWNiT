...
template <typename T> class Jacobi    // Successive Over Relaxation
{
private:
    AGHMatrix<T> A_mat;
    AGHMatrix<T> b_mat;
...
public:
    ...
    Jacobi(const AGHMatrix<T>& A_mat, const AGHMatrix<T>& b_mat, const unsigned& iterations, const double& eps = -1.0);
